...
namespace JellyFish.EditorTools.SpriteExtractor
{
    ...
    public class SpriteExtractorWindow : EditorWindow
    {
        ...
        /// <summary>
        /// Sprite Extractor Window Reference.
        /// </summary>
        private static SpriteExtractorWindow _window;

        [MenuItem("JellyFish/Sprite Extractor/Sprite Extractor")]
        ...
        /// Sprite Extractor
        /// </summary>
        private readonly SpriteExtractor _extractor = new SpriteExtractor();
        ...
        private void SpriteSheetField()
        {
            ...
            SpriteSheet = EditorGUILayout.ObjectField(new GUIContent("Sprite Sheet", SpriteSheet, "Sprite Sheet"),
                                                      SpriteSheet, typeof(Texture2D)
                                                      , false) as Texture2D;
        ...
        {
            if (GUILayout.Button(new GUIContent("Extract Sprites?",
                                                "Extract all the Sub Sprites from the Sprite Sheet.")
